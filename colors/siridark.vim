...
let s:salmon3     = { "gui": "#af875f", "cterm": "137" }
let s:blue        = { "gui": "#61afef", "cterm": "75"  }
let s:purple      = { "gui": "#c678dd", "cterm": "176" }
let s:orchid      = { "gui": "#ff87d7", "cterm": "212" }
...
" Rust Syntax colors {
call s:h("rustKeyword", s:orange, "", "")
call s:h("rustIdentifier", s:red, "", "")
call s:h("rustDerive", s:salmon3, "", "")
